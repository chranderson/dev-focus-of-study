...
> [**203** Non-Authoritative Information (since HTTP/1.1](#203-non-authoritative-information)  
...
> [**401** Unauthorized](#401-unauthorized) (RFC 7235)  
...
> [**416** Requested Range Not Satisfiable](#416-requested-range-not-satisfiable) (RFC 7233)    
...
> (Internet draft)  
> Defined in the internet draft "A New HTTP Status Code for Legally-restricted Resources".[23] Intended to be used when resource access is denied for legal reasons, e.g. censorship or government-mandated blocked access. A reference to the 1953 dystopian novel Fahrenheit 451, where books are outlawed.  
